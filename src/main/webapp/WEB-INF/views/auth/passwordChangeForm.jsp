<t:messagesPanel />
<form:form action="${contextPath}/auth/password" class="form-horizontal" method="post" modelAttribute="passwordForm">
        ...
        <div class="col-sm-offset-2 col-sm-8">
            ...
            <c:if test="${!isAuthenticated}">
                <button class="btn btn-default" name="changeAndLogin">
                    <span class="glyphicon glyphicon-log-in"></span> Change and Login
                </button>
            </c:if>
        </div>
    </div>
