<ul class="nav navbar-nav">
    <li class="dropdown"><a id="userMenuLink" href="#" class="dropdown-toggle"
        data-toggle="dropdown"> <span class="glyphicon glyphicon-user"></span> <sec:authentication
                property="principal.account.firstName" /> <b class="caret"></b>
    </a>
        <ul class="dropdown-menu pull-right">
            <sec:authorize url="/profile">
                <li><a id="profileUserMenuLink" href="${contextPath}/profile"><span
            ...
            <li><a id="passwordUserMenuLink" href="${contextPath}/password"><span
                    class="glyphicon glyphicon-lock"></span> <spring:message
                        code="userMenu.changePassword" /></a></li>
            <li class="divider"></li>
            <li><a id="logoutUserMenu"><span class="glyphicon glyphicon-log-out"></span> <spring:message
