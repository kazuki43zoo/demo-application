...
<script src="<c:url value="/resources/vendor/angular-i18n/angular-locale_${locale}.js"/>"></script>
<script src="<c:url value="/resources/vendor/angular-resource/angular-resource.min.js"/>"></script>
<script src="<c:url value="/resources/app/common/common-handlers.js"/>"></script>
...
<script src="<c:url value="/resources/app/${usecaseName}/${usecaseName}.js"/>"></script>
<script src="<c:url value="/resources/app/${usecaseName}/${usecaseName}-controllers.js"/>"></script>
<script src="<c:url value="/resources/app/${usecaseName}/${usecaseName}-services.js"/>"></script>
</body>
</html>
