...
<div class="well">
    ...
    <ul class="nav nav-pills nav-stacked">
        <sec:authorize url="/app/admin/h2Console">
            <li class="${fn:startsWith(matchingPathPattern,'/app/admin/h2Console') ? 'active' : ''}">
        ...
        <sec:authorize url="/app/accounts">
            <li class="${fn:startsWith(matchingPathPattern,'/app/accounts') ? 'active' : ''}">
        ...
        <sec:authorize access="!isAuthenticated()">
            <li class="${fn:startsWith(matchingPathPattern,'/app/password') ? 'active' : ''}">
        ...
        <sec:authorize url="/app/timecards">
            <li class="${fn:startsWith(matchingPathPattern,'/app/timecards') ? 'active' : ''}">
