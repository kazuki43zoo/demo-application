<div ng-controller="TimeCardController as timeCardCtrl"
    ...
    <div id="timeCardForm" class="form-horizontal">
        ...
        <div class="form-group">
            <label for="defaultWorkPlace" class="control-label col-sm-2">
            ...
            <div class="col-sm-6">
                ...
                <button id="saveBtn"
                        class="btn btn-default"
                        ng-disabled="timeCardCtrl.loading === true || (timeCardCtrl.stored === true && timeCardCtrl.needSaveTimeCard() === false)"
    ...
    <table id="attendancesTable" class="table table-hover">
        ...
        <tr id="attendancesHeader">
            <th class="width-sm" title="<spring:message code="days" />">
                <spring:message code="thead.days"/></th>
            <th class="width-sm" title="<spring:message code="dayOfWeek" />">
                <spring:message code="thead.dayOfWeek"/></th>
            <th class="width-time" title="<spring:message code="beginTime" />">
                <spring:message code="thead.beginTime"/></th>
            <th class="width-time" title="<spring:message code="finishTime" />">
                <spring:message code="thead.finishTime"/></th>
            <th class="width-time" title="<spring:message code="actualWorkTime" />">
                <spring:message code="thead.actualWorkTime"/></th>
            <th class="width-time" title="<spring:message code="compensationTime" />">
                <spring:message code="thead.compensationTime"/></th>
            <th class="width-time" title="<spring:message code="midnightWorkingTime" />">
                <spring:message code="thead.midnightWorkingTime"/></th>
            <th class="width-sm" title="<spring:message code="tardyOrEarlyLeaving" />">
                <spring:message code="thead.tardyOrEarlyLeaving"/></th>
            <th class="width-sm" title="<spring:message code="absence" />">
                <spring:message code="thead.absence"/></th>
            <th class="width-sm" title="<spring:message code="paidLeave" />">
                <spring:message code="thead.paidLeave"/></th>
            <th class="width-sm" title="<spring:message code="specialWork" />">
                <spring:message code="thead.specialWork"/></th>
            <th title="<spring:message code="note" />">
                <spring:message code="thead.note"/></th>
            <th class="width-workPlace" title="<spring:message code="workPlace" />">
                <spring:message code="thead.workPlace"/></th>
        </tr>
        </thead>
    ...
    <table id="daySummaryTable" class="table">
        ...
        <tr id="daySummaryRow1">
            ...
            <td class="number">
                {{timeCardCtrl.total.baseWorkDays}}
                <span class="daysText"><spring:message code="days"/></span>
            </td>
            <th><spring:message code="tardyOrEarlyLeavingDays"/></th>
            <td class="number">
                {{timeCardCtrl.total.tardyOrEarlyLeavingCount}}
                <span class="daysText"><spring:message code="days"/></span>
            </td>
            <th><spring:message code="tardyOrEarlyLeavingPenaltyTargetDays"/></th>
            <td class="number">
                {{timeCardCtrl.total.tardyOrEarlyLeavingPenaltyCount}}
                <span class="daysText"><spring:message code="days"/></span>
            </td>
        </tr>
        <tr id="daySummaryRow2">
            ...
            <td class="number">
                {{timeCardCtrl.total.absenceCount}}
                <span class="daysText"><spring:message code="days"/></span>
            </td>
            <th><spring:message code="paidLeaveDays"/></th>
            <td class="number">
                {{timeCardCtrl.total.paidLeaveCount}}
                <span class="daysText"><spring:message code="days"/></span>
            </td>
            <th></th>
            <td class="number"></td>
