<div ng-controller="TimeCardController as timeCardCtrl"
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                    <input type="month" id="targetMonth"
                       class="form-control targetMonth" max="9999-12"
    ...
    <table id="attendancesTable" class="table table-hover">
        ...
        <tr id="attendancesHeader">
            <th class="width-sm" title="<spring:message code="days" />">
                <spring:message
                        code="thead.days"/></th>
            <th class="width-sm" title="<spring:message code="dayOfWeek" />">
                <spring:message
                        code="thead.dayOfWeek"/></th>
            <th class="width-time" title="<spring:message code="beginTime" />">
                <spring:message
                        code="thead.beginTime"/></th>
            <th class="width-time" title="<spring:message code="finishTime" />">
                <spring:message
                        code="thead.finishTime"/></th>
            <th class="width-time"
                title="<spring:message code="actualWorkTime" />"><spring:message
                    code="thead.actualWorkTime"/></th>
            <th class="width-time"
                title="<spring:message code="compensationTime" />">
                <spring:message
                        code="thead.compensationTime"/></th>
            <th class="width-time"
                title="<spring:message code="midnightWorkingTime" />">
                <spring:message
                        code="thead.midnightWorkingTime"/></th>
            <th class="width-sm"
                title="<spring:message code="tardyOrEarlyLeaving" />">
                <spring:message
                        code="thead.tardyOrEarlyLeaving"/></th>
            <th class="width-sm" title="<spring:message code="absence" />">
                <spring:message
                        code="thead.absence"/></th>
            <th class="width-sm" title="<spring:message code="paidLeave" />">
                <spring:message
                        code="thead.paidLeave"/></th>
            <th class="width-sm" title="<spring:message code="specialWork" />">
                <spring:message
                        code="thead.specialWork"/></th>
            <th title="<spring:message code="note" />"><spring:message
                    code="thead.note"/></th>
            <th class="width-workPlace"
                title="<spring:message code="workPlace" />"><spring:message
        ...
        <tr id="attendancesRow{{$index+1}}"
            ...
            <td class="codeName dayOfWeek">{{attendance.targetDate |
                date:'EEE'}}
            </td>
            <td class="time">{{attendance.beginTime}}</td>
            <td class="time">{{attendance.finishTime}}</td>
            <td class="time">{{attendance.actualWorkingMinute |
                formatTime:true}}
            </td>
            <td class="time">{{attendance.compensationMinute |
                formatTime:true}}
            </td>
            <td class="time">{{attendance.midnightWorkingMinute |
                formatTime:true}}
            </td>
            <td class="check"><span class="glyphicon glyphicon-ok"
                                    ng-show="attendance.tardyOrEarlyLeaving === true"></span>
            </td>
            <td class="check"><span class="glyphicon glyphicon-ok"
                                    ng-show="attendance.absence === true"></span>
            </td>
            <td class="check"><span class="glyphicon glyphicon-ok"
                                    ng-show="attendance.paidLeave === true"></span>
            </td>
        ...
        <tr id="attendancesFooter" class="total">
            ...
            <td class="time">{{timeCardCtrl.total.actualWorkingMinute |
                formatTime}}
            </td>
            <td class="time">{{timeCardCtrl.total.compensationMinute |
                formatTime}}
            </td>
            <td class="time">{{timeCardCtrl.total.midnightWorkingMinute |
                formatTime}}
            </td>
            <td class="number">{{timeCardCtrl.total.tardyOrEarlyLeavingCount}}
            </td>
    ...
    <table id="daySummaryTable" class="table">
        ...
        <tr id="daySummaryRow1">
            ...
            <td class="number">{{timeCardCtrl.total.baseWorkDays}} <span
                    class="daysText"><spring:message
                    code="days"/></span></td>
            <th><spring:message code="tardyOrEarlyLeavingDays"/></th>
            <td class="number">
                {{timeCardCtrl.total.tardyOrEarlyLeavingCount}} <span
                    class="daysText"><spring:message code="days"/></span>
            </td>
            <th><spring:message
                    code="tardyOrEarlyLeavingPenaltyTargetDays"/></th>
            <td class="number">
                {{timeCardCtrl.total.tardyOrEarlyLeavingPenaltyCount}} <span
                    class="daysText"><spring:message code="days"/></span>
            </td>
        </tr>
        <tr id="daySummaryRow2">
            <th><spring:message code="absenceDays"/></th>
            <td class="number">{{timeCardCtrl.total.absenceCount}} <span
                    class="daysText"><spring:message
                    code="days"/></span></td>
            <th><spring:message code="paidLeaveDays"/></th>
            <td class="number">{{timeCardCtrl.total.paidLeaveCount}} <span
                    class="daysText"><spring:message
                    code="days"/></span></td>
            <th></th>
            <td class="number"></td>
        ...
        <div class="col-md-5">
            <table id="timeSummaryTable" class="table">
                ...
                <tr class="total">
                    ...
                    <td>
                        <div class="time summary">
                            {{timeCardCtrl.total.baseWorkingMinute |
                            formatTime}}
                        </div>
                    </td>
                </tr>
                <tr class="total">
                    ...
                    <td>
                        <div class="time summary">
                            {{timeCardCtrl.total.workingMinute |
                            formatTime}}
                        </div>
                        <div class="time breakdown">
                            {{timeCardCtrl.total.actualWorkingMinute |
                            formatTime}}
                        </div>
                        <div class="time breakdown">
                            {{timeCardCtrl.total.compensationMinute |
                            formatTime}}
                        </div>
                    </td>
                </tr>
                <tr class="total">
                    ...
                    <td>
                        <div class="time summary"
                            ...
                            {{timeCardCtrl.total.liquidationMinute |
                            formatTime}}
                        </div>
                        <div class="time breakdown"
                ...
                <tr class="total">
                    ...
                    <td>
                        <div class="time summary">
                            {{timeCardCtrl.total.midnightWorkingMinute |
                            formatTime}}
                        </div>
                    </td>
                </tr>
        ...
        <div class="col-md-7">
            <div class="noteArea">
                <table class="table">
                    ...
                    <tbody>
                    <tr>
                        <td colspan="6"><textarea id="timeCardNote"
                                                  class="form-control"
                                                  rows="5"
                                                  ng-model="timeCardCtrl.timeCard.note"></textarea>
                        </td>
                    </tr>
                    </tbody>
                </table>
                ...
                <div class="modal-body">
                    <div id="attendanceInputArea">
                        <table id="attendanceInputTable" class="table">
                            <thead>
                            <tr>
                                <th class="targetDay"><label
                                        for="targetDay"><spring:message
                                        code="targetDays"/></label></th>
                                <th class="time"><label
                                        for="beginTime"><spring:message
                                        code="beginTime"/><br>
                                    <button id="enterBtn"
                                ...
                                <th class="paidLeave"><label
                                        for="paidLeave"><spring:message
                                        code="paidLeave"/></label></th>
                                <th class="specialWork"><label
                                        for="specialWork"><spring:message
                                        code="specialWork"/></label></th>
                                <th><label for="note"><spring:message
                                        code="note"/></label></th>
                                <th class="workPlace"><label
                                        for="workPlace"><spring:message
                        ...
                        <table id="attendanceInputCalculationResultTable"
                               class="table">
                            <thead>
                            <tr>
